...
if (!function_exists('guess_csv_type')) {
    ...
    function guess_csv_type($data) {
        ...
        if (array_key_exists('titre', $data) && array_key_exists('reference_ressource', $data) 
                && !(array_key_exists('legende', $data)) && !(array_key_exists('date_production', $data))) {
        ...
        if (array_key_exists('Type de documentation', $data) && array_key_exists('Nom de l\'objet', $data) 
                && array_key_exists('Titre de la ressource', $data)) {
