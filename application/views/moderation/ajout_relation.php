	...
	<h1><?php echo $this->lang->line('common_add_rel_form').' : '.$objet1->get_nom_objet().' et '.$objet2->get_nom_objet();?></h1>
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" value="<?php echo $this->lang->line('common_add_rel_form_submit'); ?>" />                 
                </td>
            </tr>
