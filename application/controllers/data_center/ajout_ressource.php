...
class Ajout_ressource extends MY_Controller {
    ...
    /**
     * Propose un choix du type de ressource, 
     * et redirige vers la génération de formulaire associée
     * @access public
     */
    ...
    /**
     * Génére le formulaire permettant d'ajouter une ressource textuelle à la base, 
     * valide les données et les transmets au modèle ressource_texte_model
     * 
     * @access public
     * 
     */
