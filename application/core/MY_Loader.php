...
class MY_Loader extends CI_Loader
{
	...
	function module($module = '', $class = FALSE, $path = NULL, $silent = FALSE)
	{
		...
		$module = strtolower(str_replace(EXT, '', trim($module, '/')));
	...
	/**
	 * Expose protected property _ci_model_paths
	 * needed in by Module_Model::__construct()
	 * in application/libraries/Module.php
	 *
	 * @return array
	 */
	function get_model_paths() {
		return $this->_ci_model_paths;
	}

	/**
	 * Add a model path to existing model paths
	 * @param $path
	 */
	function append_model_path($path) {
